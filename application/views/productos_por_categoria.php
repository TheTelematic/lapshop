<div class="contenidoSection">
    <h2 class="tituloSection"><a href="<?php echo base_url();?>"><img src="<?php echo base_url();?>img/logo.png" style="width: 20px;">lapshop</a><img src="<?php echo base_url();?>img/flecha.png" style="width: 15px;"><?php echo $categoria;?></h2>
