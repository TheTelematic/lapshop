<div class="contenidoSection">
    ...
    <form action="<?php echo base_url();?>index.php/Usuarios/changePass" method="post">
        ...
        <div id="dato"><span for="perfil_pass">Antigua contraseña:</span><input type="password" name="perfil_pass" id="perfil_pass" size="30" title="Antigua contraseña"></div>
